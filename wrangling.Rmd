...
```{r}
pos <- which(countrytemp$name %in% c("Bolivia (Plurinational State of)",
                                     "Czechia",
                                     "Korea (Republic of)",
                                     "Russian Federation",
                                     "Trinidad and Tobago",
...
countrytemp[pos,]$name <- c("Bolivia","Czech Republic","UK","South Korea","Russia","Trinidad","USA", "Venezuela", "Vietnam")
countrytemp$name

countrytemp[pos,]$name
```
...
# Change string United Kingdom and United States to UK and USA
pos <- which(elevation$Country %in% c("United Kingdom","United States"))
elevation[pos,1] <- c("UK", "USA")
```
